...
public class WebTable_StepDefinations {
    ...
    @And("user enters username {string} password {string} and clicks to login button")
    public void userEntersUsernamePasswordAndClicksToLoginButton(String username, String pw) {
